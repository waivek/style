...
rem pyftsubset confluence_c3_regular.woff --text-file=confluence_c3_regular_characters.txt --flavor=woff
rem pyftsubset confluence_c3_regular.woff --text-file=confluence_c3_regular_subset.txt --flavor=woff
